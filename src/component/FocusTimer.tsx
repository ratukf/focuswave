...
import { Box, Button, Typography, Stack, LinearProgress, TextField } from "@mui/material";
...
export const FocusTimer = () => {
    const { minutes, seconds, isRunning, start, pause, reset, progress } = usePomodoroTimer();
    ...
    const mood = stats.streak > 5 ? "🔥🧠" : stats.streak > 2 ? "😎" : stats.streak > 0 ? "🙂" : "😴";
    ...
    return (
        ...
        >
            ...
            <Typography variant="subtitle1" color="text.secondary" sx={{ mt: 2 }}>
                🔥 Today's focus streak: <strong>{stats.streak} days in a row</strong> {mood}
            </Typography>
        </Box>
    );
};
