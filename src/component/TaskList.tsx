        ...
        <Box>
            ...
            <List>
                {filteredTasks.map((task) => (
                    <ListItem
                        ...
                        secondaryAction={
                            editingId === task.id ? (
                                ...
                                <>
                                    <IconButton disabled={isFocusMode} onClick={() => {
                                        setEditingId(task.id);
                                        setEditText(task.title);
                                    }}>
                                        <Edit />
                                    </IconButton>
                                    <IconButton disabled={isFocusMode} onClick={() => del(task.id)}>
                                        <Delete />
                                    </IconButton>
                                </>
                            )
                    ...
                    >
                        <Checkbox disabled={isFocusMode} checked={task.done} onChange={() => toggle(task.id)} />
